/*
  ...
  - You are about to drop the column `changeToOrder` on the `ProductOrders` table. All the data in the column will be lost.
  - Added the required column `changeToOrder` to the `Order` table without a default value. This is not possible if the table is not empty.
